...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" 
    ...
    <NamedLayer>
        <se:Name>verde_plaza</se:Name>
        <UserStyle>
            <se:Name>verde_plaza_osm</se:Name>
            <se:FeatureTypeStyle>
                <se:Rule>
                    <se:Name>3dF Plazas</se:Name>
                    <se:Description>
                ...
                <se:Rule>
                    ...
                    <se:TextSymbolizer>
                        ...
                        <se:Halo>
                            ...
                            <se:Fill>
                                <se:SvgParameter name="fill">#ffffe2</se:SvgParameter>
                            </se:Fill>
                        </se:Halo>
                        <se:Fill>
                            <se:SvgParameter name="fill">#075c10</se:SvgParameter>
                        </se:Fill>
